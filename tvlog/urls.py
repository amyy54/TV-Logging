...
from .views import HomeView, ShowListView, ShowDetailView, WatchingCreateView, WatchingUpdateView, WatchingDeleteView, AboutView, SeasonCreateView, SeasonUpdateView, SeasonDeleteView
